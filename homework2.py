...
data1=pd.read_csv('C:/Users/ananyae/Downloads/RS.csv')

data2=pd.read_csv('C:/Users/ananyae/Downloads/SUNPHARMA.NS.csv')

data3=pd.read_csv('C:/Users/ananyae/Downloads/TATASTEEL.NS.csv')
...
stocks.columns=['RELIANCE','SUN','TATASTEEL']
